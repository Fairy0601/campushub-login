 ...
 *
 * @Author 欣欣欣
 * @Create 2025/2/24 14:41
 * @Version 1.0
 */
@Controller
public class LoginController implements CommunityConstant {
    public static final Logger logger = LoggerFactory.getLogger(LoginController.class);  //创建日志
    ...
    /**
     * 生成验证码：随机字符+图片
     * 由于验证码不能存储在客户端有损安全性，使用session，而不是cookie
     * @param response
     * @param session
     */
